...
var RouterContext = typeof React.createContext === "function" ? React.createContext(null) : null;
  ...
  return function App() {
    ...
    async function navigate(url, mode = "push") {
      ...
      try {
        ...
        setTree(/* @__PURE__ */ jsx("p", { children: "Failed to load route." }));
      } finally {
        setPending(false);
      }
    }
    ...
    if (!RouterContext) {
      return /* @__PURE__ */ jsxs(Fragment, { children: [
        /* @__PURE__ */ jsx(LoaderBar, { active: pending }),
        tree ?? /* @__PURE__ */ jsx("p", { style: { padding: 24 }, children: "Loading..." })
      ] });
    }
    return /* @__PURE__ */ jsxs(RouterContext.Provider, { value: routerValue, children: [
      /* @__PURE__ */ jsx(LoaderBar, { active: pending }),
      tree ?? /* @__PURE__ */ jsx("p", { style: { padding: 24 }, children: "Loading..." })
    ] });
  };
